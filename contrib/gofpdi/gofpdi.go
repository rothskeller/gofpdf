/*
Package gofpdi wraps the gofpdi PDF library to import existing PDFs as templates. See github.com/rothskeller/gofpdi
...
import (
	realgofpdi "github.com/rothskeller/gofpdi"
	"io"
)
